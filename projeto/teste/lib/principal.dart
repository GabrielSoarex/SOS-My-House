          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                _buildCircularImage('imagePaths[2]', 'Frete'),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceEvenly,
              children: [
                _buildCircularImage('imagePaths[4]', 'Picinero'),
            ...
            SizedBox(height: 10),
            // Adicione o carrossel retangular aqui
            SizedBox(height: 16),
            Text(
              'Serviços',
              style: TextStyle(
      ...
      children: [
        CircleAvatar(
          backgroundImage: AssetImage(
              'logo.png'), // Substitua pelo caminho correto da imagem
          radius: 40,
        ),
        SizedBox(height: 8),
        Text(caption),
